        ...
        with open(USCOfasta, "a+") as output_handle:
            ...
            for directory, taxa in zip(buscoDirs, taxaNames):
                ...
                if sequence_type   == 'prot':
                    indivBUSCO     = directory+"/"+directy+"/busco_sequences/single_copy_busco_sequences/"+USCOid+".faa"
                elif sequence_type == 'nucl':
                    indivBUSCO     = directory+"/"+directy+"/busco_sequences/single_copy_busco_sequences/"+USCOid+".fna"
...
def determine_USCOs(
    ...
    for directory, taxa in zip(buscoDirs, taxaNames):
        tableFileName = directory+"/"+directy+"/"+'full_table.tsv'
...
def main(
    ...
    try:
        opts, args = getopt.getopt(argv, "hb:c:o:t:d:")
